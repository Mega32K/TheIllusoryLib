...
public class ASMEventHandler2 implements IEventListener
{
    ...
    private final SubscribeRunnerEvent subInfo;
    private ModContainer owner;
    private String readable;
    private java.lang.reflect.Type filter = null;

    @Deprecated
    public ASMEventHandler2(Object target, Method method, ModContainer owner) throws Exception
    {
        this(target, method, owner, false);
    }

    public ASMEventHandler2(Object target, Method method, ModContainer owner, boolean isGeneric) throws Exception
    {
        this.owner = owner;
        ...
        subInfo = method.getAnnotation(SubscribeRunnerEvent.class);
